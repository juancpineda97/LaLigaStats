...
Además se hace uso de varios middleware para cumplir diversas tareas, como por ejemplo `express.json()` el cuál se ocupa de parsear los datos del body de una petición. También se ha programado un middleware para la gestión de errores, que capta los errores y crea la respuesta adecuada:
